                ...
                <div class="card card-form">
                    <div class="row no-gutters">
                        <div class="col-lg-4 card-body">
                            <p><strong class="headings-color">Регистрация выдачи книг</strong></p>
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-12 col-md-6 mb-3">
                                        <label for="date_out">Дата выдачи</label>
                                        <?= $form->field($model, 'date_out', [])->textInput(['id' => 'date_out', 'class' => 'form-control', 'data-toggle'=> 'flatpickr', 'value' => date('Y-m-d')])->label(false); ?>
                                    </div>
                                    <div class="col-12 col-md-6 mb-3">
                                ...
                                <div class="form-row">
                                    <div class="col-12 col-md-6 mb-3">
                                        <label for="validationSample03">Срок выдачи</label>
                                        <?= $form->field($model, 'date_back', [])->textInput(['id' => 'validationSample03', 'class' => 'form-control', 'data-toggle'=> 'flatpickr', 'value' => 'today'])->label(false); ?>
                                    </div>
                                    <div class="col-12 col-md-6 mb-3">
