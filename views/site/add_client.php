                ...
                <div class="card card-form">
                    <div class="row no-gutters">
                        <div class="col-lg-4 card-body">
                            <p><strong class="headings-color">Форма добавления клиента</strong></p>
                            <p class="text-muted">Для добавления клиента заполните все поля.</p>
                        </div>
                        <div class="col-lg-8 card-form__body card-body">
                            <?php $form = ActiveForm::begin(['id' => 'client-form', 'options'=>[]]); ?>
                                <div class="form-group">
                                    ...
                                    <div class="form-row">
                                        <div class="col-12 col-md-6 mb-3">
                                            <label for="ser">Серия паспорта</label>
                                            <?= $form->field($model, 'ser', [])->textInput(['id' => 'ser', 'class' => 'form-control'])->label(false); ?>
                                        </div>
                                        <div class="col-12 col-md-6 mb-3">
                                            <label for="num">Номер паспорта</label>
                                            <?= $form->field($model, 'num', [])->textInput(['id' => 'num', 'class' => 'form-control'])->label(false); ?>
                                        </div>
                                    </div>
                                </div>
